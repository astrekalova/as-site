...
const IndexPage = () => (
  <>
    ...
    <UpDownWide>
      <SVG icon="arrowUp" hiddenMobile width="3rem" fill={red} left="80%" top="30%" />
      <SVG icon="triangle" width="3rem" stroke={white} left="88%" top="50%" />
    ...
    <SVG icon="circle" width="3rem" fill={greyDarker} left="65%" top="70%" />
    <SVG icon="upDown" width="2rem" fill={greyDarkest} left="95%" top="85%" />
    <SVG icon="upDown" hiddenMobile width="3rem" fill={greyDarker} left="45%" top="70%" />
    <Rotate>
    ...
    <SVG icon="hexa" width="2rem" stroke={greyDarker} left="80%" top="80%" />
    <Layout>
